...
/**
 * Factory class for creating Android user controls (Views) for answers and
 * answer groups.
 * 
 * @author per
 */
public class UserControlGenerator {
	 ...
	 * @param acl
	 *            The event handler for when the answer is changed.
	 * @return A TextEdit instance.
	 */
	private EditText makeFreetextAnswer(final Answer answer,
			final AnswerChangeListener acl) {
	...
	public ViewGroup makeFreetextAnswers(ArrayList<Answer> answers,
			final AnswerChangeListener acl) {
		...
		// lparams.addRule(RelativeLayout.CENTER_VERTICAL); // center text box,
		// i hope
	...
	/**
	 * Creates a multiple choice answer group where each answer may be a
	 * pre-defined answer or a free-text answer.
	 * 
	 * @param answers
	 *            A map of answers, where the key is the answer text and the
	 *            value is a boolean denoting if it is free-text (true) or not
	 *            (false).
	 * @param acl
	 *            The event handler.
	 * @return A ViewGroup of the answers containing checkboxes.
	 */
	public ViewGroup makeMultiChoiceAnswers(ArrayList<Answer> answers,
			final AnswerChangeListener acl) {
		LinearLayout ll = new LinearLayout(context);
		ll.setOrientation(LinearLayout.VERTICAL);
		LinearLayout.LayoutParams lparams = new LinearLayout.LayoutParams(
	...
	/**
	 * Creates a single choice answer group where each answer may be a
	 * pre-defined answer or a free-text answer.
	 * 
	 * @param answers
	 *            A map of answers, where the key is the answer text and the
	 ...
	 */
	public ViewGroup makeSingleChoiceAnswers(ArrayList<Answer> answers,
			final AnswerChangeListener acl) {
		LinearLayout ll = new LinearLayout(context);
		ll.setOrientation(LinearLayout.VERTICAL);
		LinearLayout.LayoutParams lparams = new LinearLayout.LayoutParams(
	...
	public View makeRuler(int color) {
		...
		ruler.setLayoutParams(new ViewGroup.LayoutParams(
