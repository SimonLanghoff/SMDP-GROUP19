 ...
 * generated by Xtext
 */
package dk.itu.smdp.group19.formatting;
...
public class SurveyDSLFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private SurveyDSLGrammarAccess _surveyDSLGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._surveyDSLGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._surveyDSLGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._surveyDSLGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._surveyDSLGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._surveyDSLGrammarAccess.getML_COMMENTRule();
